...
@section('container')
    ...
    <div class="row m-t-30">
        <div class="col-md-12">
            <form action="{{route('admin.product.manage_product_process')}}" method="post"
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    @enderror
                                    @if($image!='')
                                        <a href="{{asset('storage/products/'.$image)}}" target="_blank"><img
                                                width="100px" src="{{asset('storage/products/'.$image)}}"/></a>
                                    @endif
                                </div>
                                <div class="form-group">
                                    <div class="row">
                                    ...
                                    <div class="row" id="product_images_box">
                                        ...
                                        @foreach($productImagesArr as $key=>$val)
                                            ...
                                            <div class="col-md-4 product_images_{{$loop_count_num++}}">
                                                ...
                                                @if($pIArr['images']!='')
                                                    <a href="{{asset('storage/products/'.$pIArr['images'])}}"
                                                       target="_blank"><img width="100px"
                                                                            src="{{asset('storage/products/'.$pIArr['images'])}}"/></a>
                                                @endif
                                            </div>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                @if($pAArr['attr_image']!='')
                                                    <img width="100px"
                                                         src="{{asset('storage/products-attr/'.$pAArr['attr_image'])}}"/>
                                                @endif
                                            </div>
                                            <div class="col-md-2">
                                                ...
                                                @else
                                                    <a href="{{url('admin/product/productAttributeImageDelete/')}}/{{$pAArr['id']}}/{{$id}}">
                                                        <button type="button" class="btn btn-danger btn-lg">
                                                            <i class="fa fa-minus"></i>&nbsp; Remove
                                                        </button>
                                                    </a>
    ...
    <script>
        ...
        function add_more() {
            ...
            html += '<div class="col-md-2"><label for="quantity" class="control-label mb-1"> Quantity</label><input id="quantity" name="quantity[]" type="text" class="form-control" aria-required="true" aria-invalid="false" required></div>';
